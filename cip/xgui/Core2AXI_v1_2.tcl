...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXI_REGISTERED_GRANT" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_M_AXI_REGISTERED_GRANT { PARAM_VALUE.C_M_AXI_REGISTERED_GRANT } {
	# Procedure called to update C_M_AXI_REGISTERED_GRANT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_REGISTERED_GRANT { PARAM_VALUE.C_M_AXI_REGISTERED_GRANT } {
	# Procedure called to validate C_M_AXI_REGISTERED_GRANT
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_AXI_REGISTERED_GRANT { MODELPARAM_VALUE.C_M_AXI_REGISTERED_GRANT PARAM_VALUE.C_M_AXI_REGISTERED_GRANT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_REGISTERED_GRANT}] ${MODELPARAM_VALUE.C_M_AXI_REGISTERED_GRANT}
}
